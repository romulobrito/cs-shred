...
def plot_csshred_results(
    ...
    fig3 = plt.gcf()
    cbar3 = fig3.colorbar(img3, ax=ax3, label=r"$SST$")
    plt.title("Reconstructed - Last Snapshot")
    
    ax4 = plt.subplot(1, 2, 2)
    img4 = ax4.imshow(subsampled[:, :, -1], cmap="coolwarm", origin="lower")
    fig4 = plt.gcf()
    cbar4 = fig4.colorbar(img4, ax=ax4, label=r"$SST$")
...
def main():
    ...
    """
    print("=== SST PLOTTING SCRIPT (CORRECTED) ===")
    
    # CS-SHRED Results
    print("\n--- CS-SHRED Results ---")
    csshred_save_path = r"./results/csshred/sst"
    csshred_load_path = r"./results/csshred/sst"
    ...
    # SHRED Results
    print("\n--- SHRED Results ---")
    shred_save_path = r"./results/shred/sst"
    shred_load_path = r"./results/shred/sst"
