...
num_sensors=1
num_epochs=640
dropout= 0.044087111139561146
l1_tol= 1.2154998362345746e-05
opt_tol= 4.64292076500138e-05
ls_tol= 0.0014916944164919412
patience= 41
step_epoch= 39


# Parâmetros de treinamento SHRED SST 07/2025
# hidden_size= 64
# hidden_layers= 4
# batch_size= 64
# lr= 0.0010717395142717928
# lambL2= 0.002119677340877928
# lambL1= 0.1808988375534989
# lambdaSNR= 0.0021087573999050407
# l1= 500
# l2= 400
# lags= 24
# num_sensors= 1
...
# Parâmetros de treinamento CS-SHRED SST 07/2025
# hidden_size= 128
# hidden_layers= 1
# batch_size= 64
# lr= 0.00955084312464149
# lambL2= 0.9509048297257328
# lambL1= 0.0038765347878688123
# lambdaSNR= 0.0029681503340864995
# l1= 500
# l2= 500
# lags= 16
# num_sensors= 1
# num_epochs= 690
# dropout= 0.054707094557371806
# l1_tol= 0.008075853211231738
# opt_tol= 0.001620442194412642
# ls_tol= 0.0057530404617140065
# patience= 50
# step_epoch= 10
...
test_recons, test_ground_truth_test, error_norm, mean_ssim, last_snapshot_ssim = evaluate_model(
    model, test_dataset_test, test_dataset_test, sc, json_save_path=save_path + r"/error_results.json"
)
